package com.sunit.global.util.httpClient;
...
public class HttpProtocolHandler {
    ...
    public HttpResponse execute(HttpRequest request, String strParaFileName, String strFilePath) throws HttpException, IOException {
        ...
        org.apache.commons.httpclient.Cookie[] cks= request.getCookies().toArray(new org.apache.commons.httpclient.Cookie[0]);
        httpclient.getState().addCookies(cks);
        // 设置连接超时  
