...
public class SessionFixationProtectionStrategy implements SessionAuthenticationStrategy {
    ...
    public void onAuthentication(Authentication authentication, HttpServletRequest request, HttpServletResponse response) {
        ...
        System.out.println("SessionFixationProtectionStrategy.onAuthentication()");
        ...
        if (hadSessionAlready && request.isRequestedSessionIdValid()) {
            ...
            logger.debug("SessionFixationProtectionStrategy.onAuthentication() invalidate sessinoId:"+session.getId());
            session.invalidate();
