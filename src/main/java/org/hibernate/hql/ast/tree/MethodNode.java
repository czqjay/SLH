...
public class MethodNode extends AbstractSelectExpression implements SelectExpression {
	...
	private void handleElements(FromReferenceNode collectionNode, String propertyName) {
		...
		String colName = collectionNode.toString();
		if(propertyName.equals("elements")&& colName.indexOf(".")>1) {
				selectColumns = collectionFromElement.toColumns( colName, propertyName, inSelect );
		}else {
